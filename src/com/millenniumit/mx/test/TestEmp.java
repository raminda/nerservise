...
public class TestEmp {
	...
	company.setCompanyName("agfrgfds");
	...
	equipments.setItemName("hard");
	equipments.setItemType(itemTypesService.getItemTypess(1));
	...
	equipmentmaping.setParentID(equipmentsService.getEquipments(1));
	...
	project.setProjectName("Dhigdfgdlli1");
